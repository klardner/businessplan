...
```{r, echo = FALSE, warning= FALSE}
flow <- data.frame(year = c(1,1,1,1,1,2,2),
                      category = c("Expenditure","Expenditure", "Receipts","Receipts","Receipts", "Expenditure", "Receipts"),
                      group = c("Ongoing expenditure", "Set-up costs", "Fees","Capital Contributions", "Term Loan", "Ongoing Expenditure","Fees"),
                      value = c(13986,415002,298340,120000,40000,512414,571668))
