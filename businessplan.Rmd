...
```{r download button dignity policy ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
...
```{r download button grievance prodcedure ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
...
```{r download button disciplinary procedure ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
...
```{r download button maternity leave ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
...
```{r download button parental leave ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
...
```{r download button health and safety ,eval = FALSE, echo = FALSE, warning=FALSE}
library(downloadthis)
