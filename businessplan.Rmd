...
Test button to download cashflow projections as excel file
...
download_file(
  path = "C:\\Users\\kiera\\Documents\\R\\RProjects\\businessplan\\cashflow.pdf",
  output_name = "Cash Flow Projections",
  button_label = "Download Cash Flow Projections",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
...
As you can see below the office is very close to the Dart Station 
...
elhqmapdata <- data.frame(elhqlat = c("53.337306116946785", "53.339629"), elhqlon = c("-6.239605848032218", "-6.238391")) # Set id markers location for dart & office
...
test_map %>% 
  add_markers(data = elhqmapdata, lat = "elhqlat", lon = "elhqlon", label = c("ELHQ Office","Dart Station"), title = c("ELHQ Office","Dart Station")) # add id's
```
...
A full list of all firm policies is set out in [Appendix 4](#appendix4). - **KL COME BACK TO**
...
Prior to commencing practice, each Partner will be required to submit a Commencement in Practice Form to the Law Society of Ireland (the “Law Society”). This form will set out all relevant details of the Partners’ backgrounds and experience, together with details of the Firm’s professional indemnity insurance and adherence to the [Solicitors Accounts Regulations 2014](http://www.irishstatutebook.ie/eli/2014/si/516/made/en/print).  
...
The Partners will also provide the Law Society with a copy of the Firm’s letterhead, details of its financial year, details of Partners’ change of firm, and any other information required. The Partners are aware of their obligations and responsibilities under the [Solicitors Accounts Regulations 2014](http://www.irishstatutebook.ie/eli/2014/si/516/made/en/print) also, and will be employing a bookkeeper to ensure these standards are met at all times.
...
The Partners are aware of the Firm’s responsibilities under the  Criminal Justice (Money Laundering and
Terrorist Financing) Acts 2010 to 2018 (as amended) (the **"AML Acts”**). 
...
A detailed review of each of the files is set out in [Appendix 3](#appendix3).
...
These start up-costs are anticipated to total €18,450, and are more particularly set out in the full Cash Flow Projections at [Appendix 5](#appendix5).
