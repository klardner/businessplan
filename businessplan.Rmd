...
The majority of the files fall outside the scope of practice of ELHQ and contain a number of ethical and professional conduct issues.

<b>[category1]{style="color:#e41a1c;"} , [category2]{style="color:#377eb8;"} , [category3]{style="color:#4daf4a;"} & [category4]{style="color:#e7298a;"}</b>

## About

Please see our [Website](elhq.ie) for more info
...
Having analysed the files of [Vendor Firm], ELHQ have decided [to / not to] purchase the files.
...
Before commencing practice, ELHQ will be required to complete a Commencement in Practice Form setting out the Partners' experience, professional indemnity insurance details and compliance with the Solicitors Accounts Regulations.
This form will then be submitted to the Law Society of Ireland (the "Law Society") Practice Regulation Executive.

Under the Solicitors (Professional Names / Notepaper) Regulations 1996, ELHQ will be required to apply to the Law Society Regulation of Practice Committee for approval to use the name ELHQ Solicitors.
While 'ELHQ' represents a combination of the initials of each of the principals of the Firm, ELHQ will still require Law Society approval to establish using a name other than that of the principals.

ELHQ will also provide the Law Society with a copy of its letterhead, a sample of which is provided at Appendix 3.

## Designated Compliance Manager

The Partners have agreed that [Partner] will be ELHQ's designated Compliance Manager responsible for ensuring compliance with the Law Society's regulatory requirements, professional standards and guidance.
...
There is potential criminal liability if ELHQ provides legal advice without a valid practising certificate so it is essential that ELHQ ensures each of the Partners has a valid and up-to-date practising certificate at all times.
...
The estimated total practising certificate fees for ELHQ for the year ending 31 December 2020 is approximately €12,000.
...
ELHQ have received a PII quote from [Insurer].
[Insurer] have offered PII cover to ELHQ at an initial annual cost of €19,000 with a self-insured excess of €20,000.
ELHQ have decided to accept this offer as [Insurer] are a reputable insurance undertaking and their quote is a reasonable price for a newly established practice.

## Anti-Money Laundering

ELHQ recognises its responsibility under the Criminal Justice (Money Laundering and Terrorist Financing) Acts 2010 and 2013 to prevent criminally or illegally obtained monies being disguised as legitimate income.
ELHQ's AML Policy includes detailed customer due diligence processes which will be followed for all clients and will only accept instructions where satisfied by the information obtained.
...
A list of the policies prepared by ELHQ, including its AML Policy, is provided at Appendix 4.

## Setting Up and Closing Files

To ensure efficiency and best practice, along with compliance with all legal and ethical obligations, ELHQ will implement an 'Opening Checklist' and 'Closing Checklist' which must be included on each file.
...
All undertakings will be entered on the undertaking register maintained by ELHQ, which will be reviewed in detail at each monthly Partners' meeting to ensure undertakings are discharged as soon as possible.
...
ELHQ also proposes to host a series of one-hour lectures setting out any relevant legal, regulatory and professional developments.
ELHQ will invite solicitors and other interested professionals to attend these lectures, which will be available both in-person and via remote access, such as video conferencing.

ELHQ will also host monthly internal group study sessions between the Partners.
This method of completing CPD is available to ELHQ as there will be more than three people in attendance at each session.
...
ELHQ has included the cost of satisfying its CPD requirements in its general training budget as set out in paragraph 8.4.
...
None of our staff have experience in conveyancing such that we can ensure the "delivery of legal services in a competent manner" in accordance with Clause 9.1 of the Law Society of Ireland's "A Guide to Good Professional Conduct for Solicitors".
...
This would potentially breach Clause 9.1 of the Law Society of Ireland's "A Guide to Good Professional Conduct for Solicitors" and Clause 3.1.1 of the CCBE Code of Conduct for European Lawyers.
...
This prohibition is set out under Section 62 of the Solicitors Act 1954, and any such agreements in contravention of this provision will be void.
...
ELHQ Solicitors are obligated to carry out both a Business Risk Assessment and a Customer Risk Assessment when onboarding new clients per Section 10 of the Criminal Justice (Money Laundering and Terrorist Financing) (Amendment) Act 2018, which amends the Criminal Justice (Money Laundering and Terrorist Financing Act 2010. The 2018 act sets out further prescribed procedural CDD obligations. Given the relatively small size of the firm, and given the lack of a dedicated AML / Compliance function in ELHQ Solicitors at time of formation, the partners have decided that it would be prudent to avoid taking on files with high risk clients until such a time as the business can fully meet its AML requirements without expending a significant time and money to ensure compliance.
...
-   **Important** - Add in Eddie Marketing/Premises/Files updates + Sam Files updates.
    Finish HR sections. Do files 9-10. - **Kieran**
...
-   Add in cross-references or amend the references - **Kieran**

-   See if you can get doc width fixed - **Kieran**

-   **IMPORTANT** - Check word-count of HTML version - **Kieran**

8.  Questions for Group

-   Everyone happy with layout?
    Any comments on the readability etc?
...
-  **Sam** - I think the act you reference in File 8 may have had an update since? [2021 act](http://www.irishstatutebook.ie/eli/2021/act/3/enacted/en/html) [A&L commentary](https://www.algoodbody.com/insights-publications/new-money-laundering-act-2021)
